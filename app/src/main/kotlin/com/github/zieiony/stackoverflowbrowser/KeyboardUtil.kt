...
object KeyboardUtil {
    ...
    fun hideKeyboard(activityContext: Activity?) {
        activityContext?.currentFocus?.let {
            val inputMethodManager = activityContext.getSystemService(Activity.INPUT_METHOD_SERVICE) as InputMethodManager
